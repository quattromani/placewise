...
<li><code>^0.1.3</code> := <code>0.1.3</code> &quot;Compatible with <code>0.1.3</code>&quot;. <code>0.x.x</code> versions are
special: since the semver spec specifies that <code>0.x.x</code> versions make
