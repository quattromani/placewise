...
slash characters, so <code>a{/b/c,bcd}</code> would expand into <code>a/b/c</code> and <code>abc</code>.</p>
<p>The following characters have special magic meaning when used in a
path portion:</p>
<ul>
<li><code>*</code> Matches 0 or more characters in a sinle path portion</li>
...
<h2 id="glob-hasmagic-patter-options-">glob.hasMagic(patter, [options])</h2>
...
<li><code>nocase</code> Perform a case-insensitive match.  Note that
...
and stat will not raise an error.</li>
