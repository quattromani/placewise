...
<pre><code>$ npm install co</code></pre>
...
<h2 id="thunks-vs-promises">Thunks vs promises</h2>
...
<pre><code class="lang-js">fs.readFile(path, encoding, function(err, result){
...
<pre><code class="lang-js">function read(path, encoding) {
  return function(cb){
...
<h2 id="receiver-propagation">Receiver propagation</h2>
...
<pre><code class="lang-js">var ctx = {};
...
<pre><code class="lang-js">co(function *(a){
  assert(this == ctx);
  assert(&#39;yay&#39; == a);
  yield foo;
}).call(ctx, &#39;yay&#39;);</code></pre>
<h2 id="api">API</h2>
<h3 id="co-fn-">co(fn)</h3>
...
<pre><code class="lang-js">var exec = require(&#39;co-exec&#39;);
co(function *(cmd) {
  var res = yield exec(cmd);
  return res;
})(&#39;pwd&#39;, done);</code></pre>
<h3 id="yield-array">yield array</h3>
...
console.log(yield [a, b]);</code></pre>
<h3 id="yield-object">yield object</h3>
