...
<html>
  ...
  <body>  
    <h1 id="js-yaml-yaml-1-2-parser-and-serializer-for-javascript">JS-YAML - YAML 1.2 parser and serializer for JavaScript</h1>
...
<pre><code>npm install -g js-yaml</code></pre>
...
Optional arguments:
  ...
  -t, --trace    Show stack trace on error</code></pre>
<h3 id="bundled-yaml-library-for-browsers">Bundled YAML library for browsers</h3>
<pre><code class="lang-html">&lt;!-- esprima required only for !!js/function --&gt;
...
info.</p>
<pre><code class="lang-javascript">yaml = require(&#39;js-yaml&#39;);
fs   = require(&#39;fs&#39;);
...
<li><code>schema</code> <em>(default: <code>DEFAULT_SAFE_SCHEMA</code>)</em> - specifies a schema to use.<ul>
...
<pre><code class="lang-javascript">var untrusted_code = &#39;&quot;toString&quot;: !&lt;tag:yaml.org,2002:js/function&gt; &quot;function (){very_evil_thing();}&quot;&#39;;

// I&#39;m just converting that string, what could possibly go wrong?
require(&#39;js-yaml&#39;).load(untrusted_code) + &#39;&#39;</code></pre>
...
<pre><code class="lang-javascript">var yaml = require(&#39;js-yaml&#39;);
...
!!null, !!bool, !!float
  ...
  &quot;camelcase&quot;   =&gt; &quot;Null&quot;, &quot;True&quot;, &quot;False&quot;, &quot;.NaN&quot;, &#39;.Inf&#39;</code></pre>
...
!!js/function &#39;function () {...}&#39;   # Function</code></pre>
<h2 id="caveats">Caveats</h2>
<p>Note, that you use arrays or objects as key in JS-YAML. JS do not allows objects
...
: - baz
  - baz</code></pre>
<pre><code class="lang-javascript">{ &quot;foo,bar&quot;: [&quot;baz&quot;], &quot;[object Object]&quot;: [&quot;baz&quot;, &quot;baz&quot;] }</code></pre>
...
<pre><code class="lang-yaml">&amp;anchor foo:
  foo: bar
  *anchor: duplicate key
  baz: bat
  *anchor: duplicate key</code></pre>
<h2 id="breaking-changes-in-2-x-x-3-x-x">Breaking changes in 2.x.x -&gt; 3.x.x</h2>
<p>If your have not used <strong>custom</strong> tags or loader classes and not loaded yaml
