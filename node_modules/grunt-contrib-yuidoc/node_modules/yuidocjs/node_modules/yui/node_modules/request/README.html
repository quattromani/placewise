...
<pre><code class="lang-javascript">request.get(&#39;unix://tmp/unix.socket/httppath&#39;)</code></pre>
...
// or
request.post(&#39;http://service.com/upload&#39;).form({key:&#39;value&#39;})</code></pre>
...
<pre><code class="lang-javascript">var r = request.post(&#39;http://service.com/upload&#39;, function optionalCallback (err, httpResponse, body) {
  if (err) {
...
// Alternatively, you can provide a callback (that&#39;s what this example does — see `optionalCallback` above).</code></pre>
...
<h3 id="request-options-callback-">request(options, callback)</h3>
...
<pre><code class="lang-javascript">request.cookie(&#39;cookie_string_here&#39;)</code></pre>
...
<p>OR</p>
<pre><code class="lang-javascript">// `npm install --save tough-cookie` before this works
var j = request.jar()
