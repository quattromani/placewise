...
<html>
  ...
  <body>  
    <h1 id="ipaddr-js-an-ipv6-and-ipv4-address-manipulation-library">ipaddr.js — an IPv6 and IPv4 address manipulation library</h1>
...
<pre><code class="lang-js">var ipaddr = require(&#39;ipaddr.js&#39;);</code></pre>
...
<p>For example:</p>
<pre><code class="lang-js">var addr = ipaddr.parse(&quot;2001:db8:1234::1&quot;);
var range = ipaddr.parse(&quot;2001:db8::&quot;);

addr.match(range, 32); // =&gt; true</code></pre>
...
<pre><code class="lang-js">var rangeList = {
...
ipaddr.subnetMatch(ipaddr.parse(&#39;2001:470:8:66::1&#39;), rangeList, &#39;unknown&#39;); // =&gt; &quot;he.net&quot;</code></pre>
...
<pre><code class="lang-js">var bytes = ipaddr.parse(&#39;2a00:1450:8007::68&#39;).toByteArray(); // ipv6.google.com
bytes // =&gt; [42, 0x00, 0x14, 0x50, 0x80, 0x07, 0x00, &lt;zeroes...&gt;, 0x00, 0x68 ]</code></pre>
...
<p>For example:</p>
<pre><code class="lang-js">var addr = ipaddr.parse(&quot;2001:0db8::0001&quot;);
addr.toString(); // =&gt; &quot;2001:db8::1&quot;
addr.toNormalizedString(); // =&gt; &quot;2001:db8:0:0:0:0:0:1&quot;</code></pre>
...
<pre><code class="lang-js">var addr = ipaddr.parse(&quot;2001:db8:10::1234:DEAD&quot;);
addr.parts // =&gt; [0x2001, 0xdb8, 0x10, 0, 0, 0, 0x1234, 0xdead]</code></pre>
...
<pre><code class="lang-js">var addr = ipaddr.parse(&quot;192.168.1.1&quot;);
addr.octets // =&gt; [192, 168, 1, 1]</code></pre>
