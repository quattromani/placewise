...
<pre><code class="lang-bash">npm install marked --save</code></pre>
<h2 id="usage">Usage</h2>
<p>Minimal usage:</p>
<pre><code class="lang-js">var marked = require(&#39;marked&#39;);
console.log(marked(&#39;I am using __markdown__.&#39;));
// Outputs: &lt;p&gt;I am using &lt;strong&gt;markdown&lt;/strong&gt;.&lt;/p&gt;</code></pre>
...
console.log(marked(markdownString));</code></pre>
...
console.log(marked(&#39;# heading+&#39;, { renderer: renderer }));</code></pre>
...
console.log(tokens);
console.log(lexer.rules);</code></pre>
<h2 id="cli">CLI</h2>
...
markdown-js completed in 17191ms.</code></pre>
