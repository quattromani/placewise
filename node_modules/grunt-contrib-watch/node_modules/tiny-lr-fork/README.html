...
<html>
  ...
  <body>  
    <p>This is a fork of tiny-lr. The maintainer of tiny-lr appears to be on a hiatus and this fork takes care of lingering issues until the maintainer of tiny-lr (hopefully) returns.</p>
...
<pre><code class="lang-js">var tinylr = require(&#39;tiny-lr&#39;);
...
<pre><code class="lang-js">var server = tinylr();
...
<pre><code class="lang-js">server.close();</code></pre>
...
<pre><code class="lang-js">// This binds both express app and tinylr on the same port
var app = express();
...
<pre><code class="lang-js">grunt.loadNpmTasks(&#39;tiny-lr&#39;);</code></pre>
<ul>
...
<pre><code class="lang-make">CSS_DIR = app/styles
...
<pre><code class="lang-make">reload: reload-js reload-css reload-img reload-EVERYTHING</code></pre>
...
<p><a name="tiny-lr" /></p>
<h1 id="tiny-lr">tiny-lr</h1>
<p>accepts ws clients.</p>
<pre><code class="lang-js">var url = parse(this.request.url);
var server = this.app;
...
<pre><code class="lang-js">var ws = this.ws;
...
<pre><code class="lang-js">request(this.server)
  .get(&#39;/&#39;)
...
<h2 id="get-changed">GET /changed</h2>
...
<h2 id="post-changed">POST /changed</h2>
<p>with no clients, no files.</p>
<pre><code class="lang-js">request(this.server)
  .post(&#39;/changed&#39;)
  .expect(&#39;Content-Type&#39;, /json/)
  ...
  .expect(200, done);</code></pre>
<p>with no clients, some files.</p>
<pre><code class="lang-js">var data = { clients: [], files: [&#39;cat.css&#39;, &#39;sed.css&#39;, &#39;ack.js&#39;] };
...
<h2 id="get-livereload-js">GET /livereload.js</h2>
...
<h2 id="get-kill">GET /kill</h2>
<p>shutdown the server.</p>
<pre><code class="lang-js">var server = this.server;
request(server)
  .get(&#39;/kill&#39;)
