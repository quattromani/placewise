...
<html>
  ...
  <body>  
    <h1 id="grunt-contrib-watch-v0-6-1-build-status-https-travis-ci-org-gruntjs-grunt-contrib-watch-png-branch-master-https-travis-ci-org-gruntjs-grunt-contrib-watch-">grunt-contrib-watch v0.6.1 <a href="https://travis-ci.org/gruntjs/grunt-contrib-watch"><img src="https://travis-ci.org/gruntjs/grunt-contrib-watch.png?branch=master" alt="Build Status"></a></h1>
<blockquote>
...
<pre><code class="lang-shell">npm install grunt-contrib-watch --save-dev</code></pre>
<p>Once the plugin has been installed, it may be enabled inside your Gruntfile with this line of JavaScript:</p>
<pre><code class="lang-js">grunt.loadNpmTasks(&#39;grunt-contrib-watch&#39;);</code></pre>
<h2 id="watch-task">Watch task</h2>
<p><em>Run this task with the <code>grunt watch</code> command.</em></p>
<h3 id="settings">Settings</h3>
<p>There are a number of options available. Please review the <a href="https://github.com/isaacs/minimatch#options">minimatch options here</a>. As well as some additional options as follows:</p>
...
<p><em>For backwards compatibility the option <code>nospawn</code> is still available and will do the opposite of <code>spawn</code>.</em></p>
<h4 id="options-interrupt">options.interrupt</h4>
<p>Type: <code>Boolean</code>
Default: false</p>
<p>As files are modified this watch task will spawn tasks in child processes. The default behavior will only spawn a new child process per target when the previous process has finished. Set the <code>interrupt</code> option to true to terminate the previous process and spawn a new one upon later changes.</p>
<p>Example:</p>
<pre><code class="lang-js">watch: {
  scripts: {
    files: &#39;**/*.js&#39;,
...
<h4 id="options-debouncedelay">options.debounceDelay</h4>
<p>Type: <code>Integer</code>
Default: 500</p>
<p>How long to wait before emitting events in succession for the same filepath and status. For example if your <code>Gruntfile.js</code> file was <code>changed</code>, a <code>changed</code> event will only fire again after the given milliseconds.</p>
<p>Example:</p>
<pre><code class="lang-js">watch: {
  scripts: {
    files: &#39;**/*.js&#39;,
...
<h4 id="options-interval">options.interval</h4>
<p>Type: <code>Integer</code>
Default: 100</p>
<p>The <code>interval</code> is passed to <code>fs.watchFile</code>. Since <code>interval</code> is only used by <code>fs.watchFile</code> and this watcher also uses <code>fs.watch</code>; it is recommended to ignore this option. <em>Default is 100ms</em>.</p>
<h4 id="options-event">options.event</h4>
<p>Type: <code>String|Array</code>
Default: <code>&#39;all&#39;</code></p>
<p>Specify the type watch event that trigger the specified task. This option can be one or many of: <code>&#39;all&#39;</code>, <code>&#39;changed&#39;</code>, <code>&#39;added&#39;</code> and <code>&#39;deleted&#39;</code>.</p>
<p>Example:</p>
<pre><code class="lang-js">watch: {
  scripts: {
    files: &#39;**/*.js&#39;,
...
<h4 id="options-reload">options.reload</h4>
<p>Type: <code>Boolean</code>
Default: <code>false</code></p>
<p>By default, if <code>Gruntfile.js</code> is being watched, then changes to it will trigger the watch task to restart, and reload the <code>Gruntfile.js</code> changes.
When <code>reload</code> is set to <code>true</code>, changes to <em>any</em> of the watched files will trigger the watch task to restart.
This is especially useful if your <code>Gruntfile.js</code> is dependent on other files.</p>
<pre><code class="lang-js">watch: {
  configFiles: {
...
<h4 id="options-forever">options.forever</h4>
<p>Type: <code>Boolean</code>
Default: true</p>
<p>This is <em>only a task level option</em> and cannot be configured per target. By default the watch task will duck punch <code>grunt.fatal</code> and <code>grunt.warn</code> to try and prevent them from exiting the watch process. If you don&#39;t want <code>grunt.fatal</code> and <code>grunt.warn</code> to be overridden set the <code>forever</code> option to <code>false</code>.</p>
<h4 id="options-dateformat">options.dateFormat</h4>
<p>Type: <code>Function</code></p>
<p>This is <em>only a task level option</em> and cannot be configured per target. By default when the watch has finished running tasks it will display the message <code>Completed in 1.301s at Thu Jul 18 2013 14:58:21 GMT-0700 (PDT) - Waiting...</code>. You can override this message by supplying your own function:</p>
<pre><code class="lang-js">watch: {
  options: {
...
<h4 id="options-atbegin">options.atBegin</h4>
<p>Type: <code>Boolean</code>
Default: false</p>
<p>This option will trigger the run of each specified task at startup of the watcher.</p>
<h4 id="options-livereload">options.livereload</h4>
<p>Type: <code>Boolean|Number|Object</code>
Default: false</p>
<p>Set to <code>true</code> or set <code>livereload: 1337</code> to a port number to enable live reloading. Default and recommended port is <code>35729</code>.</p>
...
<p>It&#39;s possible to get livereload working over https connections. To do this, pass an object to <code>livereload</code> with a <code>key</code> and <code>cert</code> paths specified.</p>
<p>Example:</p>
<pre><code class="lang-js">watch: {
  css: {
    files: &#39;**/*.sass&#39;,
...
<p>Ability to set the current working directory. Defaults to <code>process.cwd()</code>. Can either be a string to set the cwd to match files and spawn tasks. Or an object to set each independently. Such as <code>options: { cwd: { files: &#39;match/files/from/here&#39;, spawn: &#39;but/spawn/files/from/here&#39; } }</code>.</p>
<h4 id="options-livereloadonerror">options.livereloadOnError</h4>
<p>Type: <code>Boolean</code><br>Default: <code>true</code>  </p>
<p>Option to prevent the livereload if the executed tasks encountered an error.  If set to <code>false</code>, the livereload will only be triggered if all tasks completed successfully.</p>
...
<h4 id="using-the-watch-event">Using the <code>watch</code> event</h4>
...
<h5 id="compiling-files-as-needed">Compiling Files As Needed</h5>
...
<h4 id="live-reloading">Live Reloading</h4>
...
<h5 id="enabling-live-reload-in-your-html">Enabling Live Reload in Your HTML</h5>
...
<pre><code class="lang-html">&lt;script src=&quot;//localhost:35729/livereload.js&quot;&gt;&lt;/script&gt;</code></pre>
<p>Feel free to add this script to your template situation and toggle with some sort of <code>dev</code> flag.</p>
<h5 id="using-live-reload-with-the-browser-extension">Using Live Reload with the Browser Extension</h5>
...
<h5 id="using-connect-middleware">Using Connect Middleware</h5>
...
<h5 id="rolling-your-own-live-reload">Rolling Your Own Live Reload</h5>
...
<h5 id="live-reload-with-preprocessors">Live Reload with Preprocessors</h5>
...
<h3 id="faqs">FAQs</h3>
<h4 id="how-do-i-fix-the-error-emfile-too-many-opened-files-">How do I fix the error <code>EMFILE: Too many opened files.</code>?</h4>
...
<h4 id="can-i-use-this-with-grunt-v0-3-">Can I use this with Grunt v0.3?</h4>
<p><code>grunt-contrib-watch@0.1.x</code> is compatible with Grunt v0.3 but it is highly recommended to upgrade Grunt instead.</p>
<h4 id="why-is-the-watch-devouring-all-my-memory-cpu-">Why is the watch devouring all my memory/cpu?</h4>
...
<h4 id="why-spawn-as-child-processes-as-a-default-">Why spawn as child processes as a default?</h4>
...
<li>2012-12-15   v0.2.0a   Conversion to grunt v0.4 conventions. Remove node v0.6 and grunt v0.3 support. Allow watch task to be renamed. Use grunt.util.spawn &quot;grunt&quot; option. Updated to gaze@0.3.0, forceWatchMethod option removed.</li>
...
<hr>
<p>Task submitted by <a href="http://dontkry.com">Kyle Robinson Young</a></p>
