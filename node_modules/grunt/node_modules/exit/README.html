...
<html>
  ...
  <body>  
    <h1 id="exit-build-status-https-secure-travis-ci-org-cowboy-node-exit-png-branch-master-http-travis-ci-org-cowboy-node-exit-">exit <a href="http://travis-ci.org/cowboy/node-exit"><img src="https://secure.travis-ci.org/cowboy/node-exit.png?branch=master" alt="Build Status"></a></h1>
...
<pre><code class="lang-javascript">var exit = require(&#39;exit&#39;);
...
console.log(&quot;wtf&quot;);
console.error(&quot;bro&quot;);</code></pre>
<h2 id="don-t-believe-me-try-it-for-yourself-">Don&#39;t believe me? Try it for yourself.</h2>
...
C:\node-exit\test\fixtures&gt;</code></pre>
...
<p>2013-11-26 - v0.1.2 - Fixed a bug with hanging processes.<br>2013-09-26 - v0.1.1 - Fixed some bugs. It seems to actually work now!<br>2013-09-20 - v0.1.0 - Initial release.</p>
