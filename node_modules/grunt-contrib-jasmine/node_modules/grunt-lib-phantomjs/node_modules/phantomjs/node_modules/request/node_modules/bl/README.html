...
<pre><code class="lang-js">const BufferList = require(&#39;bl&#39;)
...
console.log(bl.readUInt16LE(10)) // 0x0403</code></pre>
...
<pre><code class="lang-js">const bl = require(&#39;bl&#39;)
    , fs = require(&#39;fs&#39;)
...
<pre><code class="lang-js">const hyperquest = require(&#39;hyperquest&#39;)
    , bl         = require(&#39;bl&#39;)
...
bl.pipe(fs.createWriteStream(&#39;gibberish.txt&#39;))</code></pre>
<h2 id="api">API</h2>
<ul>
...
<pre><code class="lang-js">var bl = require(&#39;bl&#39;)
var myinstance = bl()

// equivilant to:

var BufferList = require(&#39;bl&#39;)
var myinstance = new BufferList()</code></pre>
<hr>
<p><a name="length"></a></p>
...
<p><code>append(buffer)</code> adds an additional buffer or BufferList to the internal list.</p>
<hr>
<p><a name="get"></a></p>
...
<pre><code class="lang-js">var bl = new BufferList()
...
console.log(bl.toString())</code></pre>
<hr>
