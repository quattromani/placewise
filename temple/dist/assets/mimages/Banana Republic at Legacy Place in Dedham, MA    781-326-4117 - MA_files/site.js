...
$(document).ready(function() {
    ...
    $('.inside-mon, .current-day').on('click', function(e) {
        ...
        if (self.hasClass('inside-event')) {
            ...
            contContent.html('<p id="empty-text">There are currently no events scheduled for this date. Please click one of the highlighted dates on the calendar to view upcoming events.</p>');
        }
